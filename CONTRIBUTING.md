...
- **Tlint styles** - Iroge-specific styles. Tlint is built for apps, so there are some settings that might not make sense in a package, but [download Tlint](https://github.com/Iroge/tlint) and run it on your pull requests to see if it suggests any reasonable changes.
